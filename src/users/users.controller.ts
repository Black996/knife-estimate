import { BadRequestException, Body, Controller, Delete, Get, Param, Patch, Query, UseGuards, UseInterceptors } from '@nestjs/common';
...
import { AuthenticatedGuard } from 'src/auth/authennticated.guard';
